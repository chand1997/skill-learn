...
export const POST = async (
  ...
  try {
    ...
    console.log("[sectionId_post_error]", err);
...
export const DELETE = async (
  ...
  try {
    ...
    // if a course is published with 0 sections we have to make that course isPublished=false
    ...
    console.log("[sectionId_DELETE_error]", err);
    return new NextResponse("Internal Server Error", { status: 500 });
  }
};
